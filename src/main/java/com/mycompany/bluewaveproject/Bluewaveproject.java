package com.mycompany.bluewaveproject;

import java.util.ArrayList;
import java.util.Scanner;

public class Bluewaveproject {
        ...
        switch(choice)
    {
            ...
            R.AddDetails();
             int check=R.getNumofGuests().compareTo("30");
             if (check >= 1){
             price += 2000;
            }
            ...
            double s= P.CalculatePrice4Activities(events);
    
           double total= P.CalculateTotal(s,price);
...
public double CalculateTotal(double numofactvity,int price ){
     ...
     public void CardInfo() //to let user enter credit card info
     {
      ...
      System.out.println("Enter card information : ");
                         ...
                         if (cnumber.length() == 16)
                             setCreditCardNumber(cnumber);
                         else
                         {System.out.println("INVALID INPUT.");
                         System.out.println("Enter creditcard number again :");
                         cnumber = input.next();
                         setCreditCardNumber(cnumber);
                         }
                         /////////////////////////////////////////////////////////////////
                          System.out.println("Enter expiration date of the card :");
                          System.out.println("Enter year the card :");
                          String year = input.next();
                          System.out.println("Enter month the card :");
...
{
  System.out.println(" using your credit card");
}//end of display
}
      ...
      if (SearchedName.equals(reservations.get(2)))
          
         {
            reservations.clear();
             ...
             reservations.add("No number of guests was found.");
             reservations.add("No date was found."); 
             reservations.add("No name was found!"); 
             reservations.add("xxx xxxx No number was found.");
             reservations.add("No email  was found.");
             reservations.add("");
         } 
      else
      {
